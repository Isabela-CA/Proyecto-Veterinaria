...
public class Inventario {
    ...
    public Inventario(String nombre_producto, int producto_tipo_id, String descripcion,
                      String fabricante, String lote, int cantidad_stock, int stock_minimo,
                      LocalDate fecha_vencimiento, BigDecimal precio_venta) {
    ...
    public Inventario(int id, String nombre_producto, int producto_tipo_id, String descripcion,
                      String fabricante, String lote, int cantidad_stock, int stock_minimo,
                      LocalDate fecha_vencimiento, BigDecimal precio_venta) {
        this(nombre_producto, producto_tipo_id, descripcion, fabricante, lote, cantidad_stock,
